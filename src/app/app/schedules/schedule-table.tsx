...
export default function SchedulesTable<T>({
  columns,
  data,
  total,
  page,
  ...
  function navigate(params: Partial<{
    ...
    startTransition(() => {
      router.push(`/app/schedules?${query.toString()}`)
    })
  }
  ...
  function handleSortingChange(
    ...
    startTransition(() => {
      router.push(`/app/schedules?${params.toString()}`)
    })
  }
  ...
  return (
    <DataTable
      ...
      placeholder="Pesquisar por número, cliente e CPF/CNPJ e serviço"
      addButton={{
        text: "Novo Agendamento",
        url: "/app/schedules/create",
      }}
      sorting={sorting}
